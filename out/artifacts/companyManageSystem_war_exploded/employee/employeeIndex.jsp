...
<div class="shell">
    ...
    <a href="../SelectByIdServlet?id=<%=session.getAttribute("id")%>&flag=0" class="box"><i class="fa-solid fa-user"></i><span> 个人信息</span></a>
    <a href="../SelectUndoServlet" class="box"><i class="fa-solid fa-bars"></i></i><span>待办</span></a>
